...
def main():
	...
	court_keypoints = court_line_detector.predict(video_frames[0]) # only one video frame required since keypoints remain same for all frames
	...
	for ball_shot_ind in range(len(ball_shot_frames) - 1):
		...
		speed_of_the_ball_shot = distance_covered_by_ball_meters / ball_shot_time_in_seconds * 3.6
		...
		current_player_stats[f'player_{player_shot_ball}_total_shot_speed'] += speed_of_the_ball_shot
		current_player_stats[f'player_{player_shot_ball}_last_shot_speed'] = speed_of_the_ball_shot
